  ...
  return (
    <>
      ...
      '>
        ...
        <Skill name='Test Case' x="-20vw" y="2vw" />
        <Skill name='Figma' x="-5vw" y="-10vw" />
        <Skill name='Javascript' x="23vw" y="6vw" />
        <Skill name='Python' x="-30vw" y="-6vw" />
        <Skill name='Api Testing' x="0vw" y="12vw" />
        <Skill name='Cypress' x="-20vw" y="-15vw" />
        <Skill name='Selenium' x="15vw" y="-12vw" />
        <Skill name='Appium' x="32vw" y="-5vw" />
        <Skill name='Bug Reporting' x="0vw" y="-20vw" />
        <Skill name='K6' x="-20vw" y="18vw" />
        <Skill name='Cucumber' x="18vw" y="18vw" />
      </div>
    </>
  )
}
