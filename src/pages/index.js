...
import animationTesting from '../styles/animation.json'
...
export default function Home() {
  return (
    <>
      <Head>
        <title>Portofolio Iqbal Kurnia</title>
        <meta name="index" content="Generated by create next app" />
      </Head>
      <TransitionEffect />
      <main className='flex items-center text-dark min-h-screen sm:min-h-0 dark:text-light'>
        <Layout className='pt-0 md:p-16 sm:pt-8'>
          <div className='flex items-center justify-between w-full lg:flex-col'>
            <div className='w-1/2 md:w-full'>
              ...
              <Player autoplay loop src={animationTesting} speed={0.5} className='w-full h-auto lg:hidden md:inline-block md:w-full 2xl:pr-10 xl:pr-10'/>
            </div>
